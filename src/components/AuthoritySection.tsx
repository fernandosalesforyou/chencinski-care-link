...
const items = [
  {
    ...
    text: "Formado pela Faculdade de Medicina da USP. Título de especialista em homeopatia pela Associação Médica Homeopática Brasileira (AMHB).",
  },
  {
    icon: BookOpen,
    title: "Autor de 3 Livros",
    text: "HOMEOPATIA Mais Simples do Que Parece · GERAR E NASCER um canto de amor e aconchego · CRÔNICAS AGUDAS de aleitamento materno.",
  },
  {
    icon: GraduationCap,
