...
const faqs = [
  ...
  },
  {
    ...
    a: "A conduta é definida de forma individual caso a caso, podendo ser utilizados apenas remédios homeopáticos ou combinados com medicamentos alopáticos se necessário.",
  },
  {
    q: "Atende adultos?",
